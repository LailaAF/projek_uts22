...
?>
  ...
  <div class="content-wrapper">
    ...
    ?>
    <h1 style="text-align: center; margin-top: 10px;">Data Siswa</h1>
      <table class="table table-success table-striped" style="width:600px; height: 100px; margin-left: 250px;">
        <tr>
          <td>No</td>
          <td>Nim</td>
          <td>Uts</td>
